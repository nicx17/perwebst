...
export const optimizationNotes: [string, string][] = [
  [
    'Rendering',
    'Astro SSR with hybrid output. Static assets fingerprinted and immutable-cached for 1 year.',
  ],
  [
    'Backgrounds',
    'Progressive loading: 72px placeholder, then AVIF (or WebP fallback) with crossfade transition.',
  ],
  [
    'Typography',
    'System font stack to eliminate layout shift and external font fetches.',
  ],
  [
    'Caching',
    'Tiered cache-control: immutable for hashed assets, 30-day for backgrounds, must-revalidate for HTML.',
  ],
  [
    'Compression',
    'Cloudflare edge compression (Brotli/gzip). Background images pre-optimized to AVIF and WebP.',
  ],
  [
    'Security',
    'CSP with nonces and strict-dynamic, HSTS, COEP/COOP/CORP, X-Frame-Options DENY, Permissions-Policy.',
  ],
];
