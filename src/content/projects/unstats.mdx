...
_(Note: Currently pending addition to the HACS default store. Until merged, you may add `https://github.com/nicx17/unstats` as a custom integration repository.)_
...
1. The integration sends a request containing _only your Unsplash Username_ to `https://un.hyclotron.com`.
